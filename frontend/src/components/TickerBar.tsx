...
export default function TickerBar({ indices }: { indices: IndexQuote[] }) {
  const global = indices.filter((q) => q.group === "global");

  return (
    <footer className="sticky bottom-0 z-20 flex items-center gap-6 border-t border-line bg-base/95 px-6 py-3 text-[0.8125rem] backdrop-blur">
